...
function Contact() {
  ...
  const handleSubmit=(e)=>
  {
    ...
    console.log(data)
    if(email.length>10 && name.length>5 && phonenumber.length===10 && message.length>1)
    {
    axios.post('http://localhost:8085/postContact',data)
    try
    {
  ...
  return (
    ...
    <div style={{display:"flex"}}>
    <img src={pic1} style={{height:"1cm",width:"1cm",marginTop:"1cm"}}></img><h1>KaramCare@gamil.com</h1>
    </div>
    <div style={{display:"flex"}}>
